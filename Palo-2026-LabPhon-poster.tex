  ...
  \begin{columns}[t]
    \begin{column}{.4\linewidth}
      ...
      \begin{block}{Background: Phonetic Segmentation}
            \begin{itemize}
            \item Segmenting audio data has been part of our phonetic analysis toolset ever since the invention of audio recordings. 
            ...
            \end{itemize}
            \item Segmentation has also become more complex with the
              introduction of ever improving articulatory recording methods and
              other multimodal data, and the need to analyse them in conjunction
              with traditional audio recordings. 
      ...
      \begin{block}{Purpose: Teach Segmentation with Minimal Effort}
        ...
        \item On the surface it might seem that the days of us needing to do
          manual segmentation are coming to an end, but even if this does
          eventually happen, at the moment we still need expert human
          segmenters for two crucial tasks.
        \item First, the deep learning frameworks need data to learn from and
          this data needs to be well matched with what ever dataset we wish to
          eventually analyse.
        \item Second, even if it should happen that we get a magical large
      ...
      \begin{block}{Method: Automated Exercises}
        ...
        \item The idea is really very simple: Take any Praat TextGrids and the
        ...
        \item This all has been implemented in PATKIT (Phonetic Analysis
          ToolKIT, \citep{PaloEtAl-PATKITPhoneticAnalysis-2026}) which is a
          analysis and annotation program for phonetic data written in the
